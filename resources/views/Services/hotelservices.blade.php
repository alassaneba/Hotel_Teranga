...
@section('title', "Liste Service Hotel")
@section('css')
        ...
        @foreach($service as $services)
            <tbody class="text-center">
                <tr>
                    ...
                    <td><img src="{{$services->Image}}" style="width: 75px "></td>
                    <td> <p class="btn btn-outline-secondary"><a href="servicesedit/{{$services->id}}">Editer</a></p></td>
                    <td><form action="servicesedit/{{$services->id}}" method="post" onsubmit="return confirm('Voulez-vous supprimer ?')">
                        @csrf
                        @method('delete')
