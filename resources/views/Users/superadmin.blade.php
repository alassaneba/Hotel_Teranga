      ...
      <div class="col-xl-3 col-sm-4 mb-3">
                ...
                <div class="col-xl-3 col-sm-4 mb-3">
                    <div class="card text-white bg-navy o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">{{$servicesupp_count}} Services supp hotel</div>
                        </div>
                        <a class="card-footer text-white clearfix small z-1" href="{{route('hotel/servicesupp')}}">
                            <span class="float-left">Liste des services supp hotel</span>
                            <span class="float-right"><i class="fas fa-angle-right"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-4 mb-3">
                    <div class="card text-white bg-navy o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="{{route('hotel/apropos')}}">
